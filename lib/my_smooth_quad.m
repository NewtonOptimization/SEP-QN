function op = my_smooth_quad(sPrev, Ninv_s, Ninv_y, D, YS, SS, SNY, SNS, grad_g_x, hDiag, H_x )
...
op = @(varargin) my_smooth_quad_matrix( sPrev, Ninv_s, Ninv_y, D, YS, SS, SNY, SNS, grad_g_x, hDiag, H_x, varargin{:} );

end


function [ v, g ] = my_smooth_quad_matrix( sPrev, Ninv_s, Ninv_y, D, YS, SS, SNY, SNS, grad_g_x, hDiag, H_x, x, t)
